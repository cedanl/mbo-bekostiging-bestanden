...
| 6 | Afsluitdatum | Ja | D `ccyy-mm-dd` | Datum waarop de POK is opgesteld | `2023-01-07` |
| 7 | Datum begin | Ja | D `ccyy-mm-dd` | Startdatum BPV | `2023-02-01` |
| 8 | Datum einde gepland | Ja | D `ccyy-mm-dd` | Geplande einddatum BPV | `2025-01-29` |
| 9 | Datum einde werkelijk | Nee | D `ccyy-mm-dd` | Werkelijke einddatum BPV | `2024-08-30` |
| 10 | Omvang | Nee | N1..4 | Totaal aantal uren BPV | `2163` |
| 11 | LeerbedrijfID | Ja | N9 | SBB-nummer van het leerbedrijf (100000000–999999999) | `100018965` |
| 12 | Opleidingcode | Nee | AN5 | CREBO-code van de BPV-opleiding | `25655` |
...
| 5 | Volgnummer | Ja | AN1..20 | Door instelling toegekend volgnummer voor de POK | `C1` |
| 6 | Afsluitdatum | Ja | D `ccyymmdd` | Datum waarop de POK is opgesteld | `20230107` |
| 7 | Datum begin | Ja | D `ccyymmdd` | Startdatum BPV | `20230201` |
| 8 | Datum einde gepland | Ja | D `ccyymmdd` | Geplande einddatum BPV | `20250129` |
| 9 | Datum einde werkelijk | Nee | D `ccyymmdd` | Werkelijke einddatum BPV | `20240830` |
| 10 | Omvang | Ja | N10 | Totaal aantal uren BPV | `2163` |
| 11 | LeerbedrijfID | Ja | N10 | SBB-nummer van het leerbedrijf | `100018965` |
| 12 | Opleidingcode | Nee | AN5 | CREBO-code van de BPV-opleiding | `25655` |
