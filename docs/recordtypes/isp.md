...
| 6 | Opleidingcode | Ja | AN5 | 5-cijferige CREBO-code | `25655` |
| 7 | Leertraject | Ja | AN2..6 | Zie [Waardenlijsten](../waardenlijsten.md#leertraject) | `BBL` |
| 8 | Niveau | Nee | AN5 | Zie [Waardenlijsten](../waardenlijsten.md#niveau) | — |
| 9 | Indicatie bekostigbaar | Ja | AN1 | `J` = bekostigbaar, `N` = niet | `J` |
| 10 | Locatiecode VSV | Nee | AN12 | NHR-vestigingsnummer van de onderwijslocatie | — |
| 11 | Onderwijsaanbieder | Nee | AN7 | RIO-code, formaat `nnnAnnn` | `100A501` |
| 12 | Onderwijslocatie | Nee | AN7 | RIO-code, formaat `nnnXnnn` | `101X591` |
...
| 6 | Datum eind | Nee | D `ccyymmdd` | Einddatum van de periode | `20250116` |
| 7 | Opleidingcode | Ja | AN5 | 5-cijferige CREBO-code | `25655` |
| 8 | Niveau | Nee | AN5 | Zie [Waardenlijsten](../waardenlijsten.md#niveau) | — |
| 9 | Leertraject | Ja | AN6 | Zie [Waardenlijsten](../waardenlijsten.md#leertraject) | `BBL` |
| 10 | Locatiecode VSV | Nee | AN12 | NHR-vestigingsnummer | — |
| 11 | Indicatie bekostigbaar | Ja | B | `1` = bekostigbaar, `0` = niet | `1` |
| 12 | Onderwijsaanbieder | Nee | AN7 | RIO-code `nnnAnnn` | `100A501` |
| 13 | Onderwijslocatie | Nee | AN7 | RIO-code `nnnXnnn` | `101X591` |
