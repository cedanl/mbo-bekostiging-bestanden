...
| 5 | Opleidingcode diploma | Nee | AN5 | Opleiding van het diploma; alleen bij diploma-KZD | `25655` |
| 6 | Resultaatvolgnummer | Ja | AN1..20 | Eigen volgnummer van dit KZD-record | `8286772` |
| 7 | Code keuzedeel | Ja | AN5 | Unieke identificatie van het keuzedeel | `K0067` |
| 8 | Datum resultaat | Nee | D `ccyy-mm-dd` | Alleen bij los keuzedeel | — |
| 9 | Resultaat | Ja | AN1..12 | `Behaald` of `Niet behaald` | `Behaald` |
...
| 4 | Resultaatvolgnummer diploma | Nee | AN1..20 | Koppeling naar DIP; leeg bij los KZD | `8286771` |
| 5 | Resultaatvolgnummer | Ja | AN1..20 | Eigen volgnummer | `8286772` |
| 6 | Code keuzedeel | Ja | AN5 | Unieke identificatie | `K0067` |
| 7 | Resultaat | Nee | AN70 | `BEHAALD` of `NIET BEHAALD` | `BEHAALD` |
