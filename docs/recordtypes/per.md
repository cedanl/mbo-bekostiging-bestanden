...
| 6 | Leeftijd 4 | Ja | N2 | Leeftijd op 1-8 van het volgend studiejaar | `37` |
| 7 | Geslacht | Ja | AN1 | `M`, `V`, of `O` | `V` |
| 8 | Postcodecijfers | Ja | N4 | Postcode (4 cijfers); speciale waarden zie tabel | `7425` |
...
| 12 | Code geboorteland | Nee | AN4 | GBA-landcode | `6030` |
| 13 | Code geboorteland ouder 1 | Nee | AN4 | GBA-landcode | `6030` |
| 14 | Code geboorteland ouder 2 | Nee | AN4 | GBA-landcode | `6030` |
